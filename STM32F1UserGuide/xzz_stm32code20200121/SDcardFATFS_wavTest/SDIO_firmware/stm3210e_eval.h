...
extern void STM_EVAL_PBInit(Button_TypeDef Button, ButtonMode_TypeDef Button_Mode);
...
extern uint32_t SD_DMAEndOfTransferStatus(void);
extern void sFLASH_LowLevel_DeInit(void);
extern void sFLASH_LowLevel_Init(void); 
extern void LM75_LowLevel_DeInit(void);
extern void LM75_LowLevel_Init(void); 
/**
  * @}
  */
#ifdef __cplusplus
