...
#define MEM_MAX_SIZE			512  						//最大内存512
...
u16 memmapbase[MEM_ALLOC_TABLE_SIZE];//SRAM内存管理表大小

const u32 memtblsize=MEM_ALLOC_TABLE_SIZE;		//外部内存表大小
const u32 memblksize=MEM_BLOCK_SIZE;			//外部内存分块大小
const u32 memsize=MEM_MAX_SIZE;				//外部内存总大小
